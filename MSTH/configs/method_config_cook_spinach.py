...
method_configs["cook_base"] = SpaceTimeHashingTrainerConfig(
...
method_configs["cs2"] = SpaceTimeHashingTrainerConfig(
    method_name="Spatial_Time_Hashing_With_Base",
    steps_per_eval_batch=1000,
    steps_per_save=50000,
...
method_configs["cs_1"] = SpaceTimeHashingTrainerConfig(
    method_name="Spatial_Time_Hashing_With_Base",
    steps_per_eval_batch=1000,
    steps_per_save=50000,
    max_num_iterations=40000,
