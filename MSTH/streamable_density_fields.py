...
class StreamableHashMLPDensityField(Field):
    ...
    def __init__(
        ...
        if not self.use_linear:
            ...
            self.mlp_after_encoding = tcnn.Network(
                n_input_dims=num_levels * features_per_level, n_output_dims=1, network_config=config["network"]
            )
