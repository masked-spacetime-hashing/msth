...
method_configs["nerfacto_split2"] = TrainerConfig(
    method_name="nerfacto_split",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    ...
    pipeline=VanillaPipelineConfig(
        datamanager=VanillaDataManagerConfig(
            dataparser=NerfstudioDataParserConfig(scale_factor=0.333, train_val_json_split=True),
            train_num_rays_per_batch=4096,
            eval_num_rays_per_batch=4096,
            camera_optimizer=CameraOptimizerConfig(
                mode="off",
...
method_configs["nerfacto_split3"] = TrainerConfig(
    method_name="nerfacto_split",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    ...
    pipeline=VanillaPipelineConfig(
        datamanager=VanillaDataManagerConfig(
            dataparser=NerfstudioDataParserConfig(scale_factor=0.5, train_val_json_split=True),
            train_num_rays_per_batch=4096,
            eval_num_rays_per_batch=4096,
            camera_optimizer=CameraOptimizerConfig(
                mode="off",
...
method_configs["nerfacto_split4"] = TrainerConfig(
    method_name="nerfacto_split",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    ...
    pipeline=VanillaPipelineConfig(
        datamanager=VanillaDataManagerConfig(
            dataparser=NerfstudioDataParserConfig(scale_factor=0.25, train_val_json_split=True),
            train_num_rays_per_batch=4096,
            eval_num_rays_per_batch=4096,
            camera_optimizer=CameraOptimizerConfig(
                mode="off",
    ...
    optimizers={
        "proposal_networks": {
            ...
            "scheduler": ExponentialDecaySchedulerConfig(lr_final=1e-2, max_steps=10000),
        },
        "fields": {
            "optimizer": AdamOptimizerConfig(lr=1e-3, eps=1e-15),
            "scheduler": ExponentialDecaySchedulerConfig(lr_final=1e-2, max_steps=10000),
