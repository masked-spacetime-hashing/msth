...
class Nerfstudio(DataParser):
    ...
    def _generate_dataparser_outputs(self, split="train"):
        ...
        if self.config.data.suffix == ".json":
        ...
        elif self.config.train_val_json_split:
            ...
            num_train_images = len(meta_train["frames"])
        ...
        if not self.config.train_val_json_split:
        ...
        if not self.config.train_val_json_split:
            ...
            i_train = np.linspace(
                0, num_train_images - 1, num_train_images, dtype=int
            )  # equally spaced training images starting and ending at 0 and num_images-1
        print(i_train)
