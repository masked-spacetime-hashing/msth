...
export default function WebRtcWindow() {
  ...
  const getRTCPeerConnection = () => {
    ...
    //     const rate = (bytesSent / elapsed) * 1000; // bytes per second
    //     console.log(`[webrtc] transmission rate: ${rate} B/s`);

    //     // reset for next transmission
    //     bytesSent = 0;
    //     startTime = null;
    //   } else {
    //     // accumulate data for transmission rate calculation
    //     if (startTime === null) {
    //       startTime = Date.now();
    //     }
    //     bytesSent += event.candidate.candidate.length;
    //   }
    // });
